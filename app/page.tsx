  ...
  return (
    <main>
      ...
      <section className="dataset-overview" aria-label="MULPA dataset overview">
        ...
        <p>Dataset overview adapted from <a href="https://www.biorxiv.org/content/10.64898/2026.06.06.728412v1" target="_blank" rel="noreferrer">Raible et al. (2026), bioRxiv <span aria-hidden="true">↗</span></a>.</p>
      </section>
      <MontageExplorer />
      <ParticipantExplorer />
      <TaskCards />
